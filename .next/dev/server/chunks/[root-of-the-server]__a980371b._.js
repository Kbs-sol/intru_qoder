...
;
;
// Mock user store for development (since we don't have a real DB connected yet)
// In production, this would be replaced by D1 adapter queries
const users = [
    {
        id: "1",
        name: "Admin User",
...
const authConfig = {
    ...
    callbacks: {
        ...
        async signIn ({ user, account, profile }) {
            // Log sign-in attempt here (placeholder for logging system)
...
const { handlers, auth, signIn, signOut } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])(authConfig);
}),
